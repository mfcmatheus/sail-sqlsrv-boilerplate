...
LABEL maintainer="Matheus Faria"
...
RUN apt-get update \
    && apt-get install -y cron gnupg gosu curl ca-certificates zip unzip git supervisor sqlite3 libcap2-bin libpng-dev python2 dnsutils \
